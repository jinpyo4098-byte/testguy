...
# 스트림릿 페이지 설정 (게임 화면을 넓게 쓰기 위해 wide 모드 적용)
st.set_page_config(page_title="우주 양궁 게임", layout="wide")

st.title("🏹 우주 양궁 게임 (Planet Archery)")
st.markdown("마우스로 조준하고 클릭하여 화살을 쏘세요! 행성별로 중력과 배경이 다릅니다.")

# HTML, CSS, JS가 모두 포함된 게임 코드
game_html = """
<!DOCTYPE html>
<html lang="ko">
<head>
...
# Streamlit Component를 사용하여 HTML 렌더링
